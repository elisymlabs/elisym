...
- the health gate is untouched for a refusal WITH a reason, unlike every other non-zero exit - refusing is the skill working. A 43 without one is not a refusal and gates like anything else.
