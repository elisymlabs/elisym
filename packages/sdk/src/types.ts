// Payment types now live in `@elisym/pay-core`, which owns the money core.
// Re-exported here unchanged: every consumer that imported them from the SDK
// keeps working, and there is one definition.
import type { PaymentAssetRef } from '@elisym/pay-core';
