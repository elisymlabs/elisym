...
- the health gate is untouched for a refusal with a reason: refusing is the skill working, not failing. A 43 without one is not a refusal, and gates like any other failure.
