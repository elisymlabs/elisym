  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-16 p-20">
        ...
        {/* Context honesty badge (NIP-89 `context` flag): an invitation to the
            Chat tab, never a session trigger - Products-tab buys stay one-shots. */}
        <div className="mt-auto flex items-center gap-6 text-[11px] text-text-2/80">
          <svg
            aria-hidden
          ...
          {card.context === true ? 'Remembers the conversation' : 'Each message is independent'}
        </div>
      </div>
